...
/* @var $searchModel app\models\DcmdNodeGroupAttrDefSearch */
...
<form id="w0" action="/ducter/index.php?r=dcmd-node-group-attr-def/delete-all" method="post">
<div class="dcmd-node-group-attr-def-index">
    <?php
   ...
   ?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            array('attribute'=>'attr_name', 'label'=>'属性名', 'enableSorting'=>false, 'content'=> function($model, $key, $index, $column) { return Html::a($model['attr_name'],Url::to(['dcmd-node-group-attr-def/view', 'id'=>$model['attr_id']]));}),
