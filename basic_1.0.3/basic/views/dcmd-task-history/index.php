...
?>
<form id="w0" action="/ducter/index.php?r=dcmd-task-history/finish-task" method="post">
   ...
   ?>
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            array('attribute'=>'svr_name', 'label'=>'服务名称', 'enableSorting'=>false,),/// 'content'=>function($model, $key, $index, $col) { return $model->getAppName($model['svr_id']);}),
            ...
            array('attribute'=>'opr_uid','enableSorting'=>false, 'label'=>'创建者', 'filter'=>false, 'content'=>function($model, $key, $index, $col) { return $model->getOprName($model['opr_uid']);}),
