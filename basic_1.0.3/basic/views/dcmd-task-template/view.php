...
<div id="task-tmpate-view"  style="background:#f1f1f1;padding:10px;margin-top:10px">
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            array('attribute'=>'update_env', 'label'=>'更新环境', 'value'=>$model->convert($model['update_env'])),
    ...
    <p>
        <?= Html::a('添加', ['dcmd-task-template-service-pool/create', 'task_tmpt_id'=>$model['task_tmpt_id']], ['class' => 'btn btn-success', (Yii::$app->user->getIdentity()->admin == 1) ? "" : "style"=>"display:none"]) ?>
    </p>
