...
/**
 * This is the model class for table "dcmd_task_service_pool_attr".
 *
 * @property integer $id
 ...
 */
class DcmdTaskServicePoolAttr extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'dcmd_task_service_pool_attr';
    }
    ...
    {
        return [
            [['task_id', 'app_id', 'svr_id', 'svr_pool_id', 'attr_name', 'attr_value',  'utime', 'ctime', 'opr_uid'], 'required'],
