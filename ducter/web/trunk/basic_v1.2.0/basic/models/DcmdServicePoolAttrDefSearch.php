...
/**
 * DcmdServicePoolAttrDefSearch represents the model behind the search form about `app\models\DcmdServicePoolAttrDef`.
 */
class DcmdServicePoolAttrDefSearch extends DcmdServicePoolAttrDef
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = DcmdServicePoolAttrDef::find();
